...
function App() {
	...
	//to handle the case for added onConfirm function as dependency in the deleteConfirmation file.
	//forces the react to use the function from memory instead of recreating every time.
